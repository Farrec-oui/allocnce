      ...
      <div className="w-full max-w-[380px]">
        <div className="flex flex-col items-center gap-2.5 mb-6">
          ...
          <div className="text-center">
            <h1 className="text-[18px] font-semibold text-text">Créer un compte</h1>
            <p className="text-[12px] text-muted mt-0.5">AllocNCE · Opérations EasyJet Nice</p>
          </div>
        </div>
        ...
        >
          <div>
            <label htmlFor="fullName" className="block text-[12px] font-medium text-text mb-1">
              Nom complet
            </label>
            <input
              id="fullName"
          ...
          <div>
            <label htmlFor="confirm" className="block text-[12px] font-medium text-text mb-1">
              Confirmation
            </label>
            <input
              id="confirm"
